...
setup(
    ...
    entry_points={
        ...
        'imu_i2c=sonar_subs.read_imu_i2c:main','image_saver=sonar_subs.image_saver:main','imgpub=sonar_subs.imgpub:main',"img_match=sonar_subs.imagematcher:main",'old_reader=sonar_subs.old_data_reader_ros2:main'],
    },
)
