...
static const _KfValues_type_support_symbol_names_t _KfValues_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sonar_msgs, msg, KfValues)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sonar_msgs, msg, KfValues)),
  }
};
...
{
  return &::sonar_msgs::msg::rosidl_typesupport_cpp::KfValues_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sonar_msgs, msg, KfValues)() {
  return get_message_type_support_handle<sonar_msgs::msg::KfValues>();
}
