...
#include "sonar_msgs/msg/detail/conf_scal__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sonar_msgs::msg::ConfScal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sonar_msgs::msg::ConfScal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sonar_msgs::msg::ConfScal *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConfScal__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sonar_msgs::msg::ConfScal *>(
...
static size_t _ConfScal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ConfScal(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ConfScal__callbacks = {
  "sonar_msgs::msg",
  "ConfScal",
...
static rosidl_message_type_support_t _ConfScal__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConfScal__callbacks,
...
{
  return &sonar_msgs::msg::typesupport_fastrtps_cpp::_ConfScal__handle;
}
